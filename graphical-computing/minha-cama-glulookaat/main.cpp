...
void display(void){
  ...
  //posiciona a camera em direcao a cama
  //100,100,0 -> coloca o observador para o centro da janela
  //2.21, -1.5 seta o alvo para as coordenadas da cama
  // e por ultimo seta o valor padrao do vetor up
  gluLookAt(100,100,0.0, 2.21, -1.5,0.0, 0.0,1.0,0.0);
